...
Com a virtualização de servidores, os dispositivos de E/S físicos passam a ter que sofrer modificações já que em uma máquina física não se tem apenas um único sistema, mas sim, várias máquinas virtuais com um sistema dentro de cada uma.
