...
Existem três técnicas possíveis para operações de E/S: E/S programada, interrupção dirigida à E/S e DMA (do inglês \textit{direct memory access} -- acesso direto a memória).
