...
\section{Módulo de E/S}\index{Dispositivos de E/S}
\label{sec:dispositivosDeES}
\uline{
Um módulo de E/S é necessário para o processador conseguir se comunicar com um ou mais dispositivos externos de E/S. 
Cada dispositivo possui vários métodos de operação, diferentes formatos e comprimento de palavras e velocidade de transferência o que faz cada módulo ter uma lógica diferente.
...
Com a E/S Programada, dados são trocados entre o processador e o módulo de E/S. O processador executa um programa e dá a este controle direto das operações de E/S.
Na Interrupção dirigida à E/S um programa emite um comando de E/S e continua executando outras instruções. Ele é interrompido pelo modulo de E/S quando o ultimo terminar seu trabalho.
...
No \textit{DMA}, o modulo tem acesso direto a memória, este pode agora mover blocos de dados para ou da memória sem envolver a \textit{CPU} excetuando no começo e fim da transferência.
}
