...
Com a segmentação sendo feita fora do sistema, isso permite então enganar o \textit{MTU} da interface de rede do sistema. 
Fingindo ter um MTU alto o pacote é segmentado em pedaços grandes e em menor quantidade quando o sistema mandar transmití-lo. Com menos pacotes a quantidade de interrupções por pacote é reduzida. 
