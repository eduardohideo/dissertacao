...
Nuvens que fornecem PaaS \uline{oferecem plataformas nas quais o cliente pode criar e implantar suas aplicações,}
 são utilizadas em casos como o \textit{Google App Engine}\footnote[2]{http://developers.google.com/appengine/} e o \textit{Windows Azure}\footnote[3]{http://www.windowsazure.com/en-us/} \sout{onde é oferecido uma plataforma para implantar aplicações}
 e nuvens que fornecem \textit{IaaS} \uline{oferecem infraestruturas computacionais ao cliente,} são utilizadas em casos como o \textit{Amazon EC2}\footnote[4]{http://aws.amazon.com/ec2/} que fornece uma infraestrutura que emula um computador.
