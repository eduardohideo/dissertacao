...
Nessa estratégia, o núcleo do sistema operacional que roda o \textit{hypervisor} não necessita de modificações. Dentro dessa categoria de \textit{hypervisores} estão o \textit{KVM}\footnote[1]{http://www.linux-kvm.org/}, o \textit{XEN}\footnote[2]{http://xen.org/}, o \textit{VMWare}\footnote[3]{http://www.vmware.com/} e o \textit{VirtualBox}\footnote[4]{http://www.virtualbox.org/}.
...
Este por sua vez, lê o \textit{buffer} de descrição, mapeia as páginas recebidas no seu espaço de endereços e pede para transmití-las através da ponte. 
...
A arquitetura de virtualização de rede do XEN apresentada nesta subseção é utilizada por outros hypevisores como por exemplo o KVM e o VMWare \cite{Santos:2008:BGS:1404014.1404017}.
% ------------------------------------------------------------------------- %%
