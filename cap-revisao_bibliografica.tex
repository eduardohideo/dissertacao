...
A mesclagem de interrupções virtuais pode ser feita no \textit{driver} virtual de \textit{backend}(na ponte dentro do \texttt{dom0}) ou no \textit{driver} virtual de \textit{frontend}(dentro de um \texttt{domU}).
