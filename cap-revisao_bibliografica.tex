...
\cite{Liao:2008:STI:1477942.1477971} propos duas otimizações na virtualização de rede:escalonamento ciente de cache e roubo de creditos de escalonamento para a recepção de pacotes. 
...
Nos experimentos comparando a estrutura padrão de virtualização e a estrutura modificada com as otimizações, foi concluído um ganho de 96\% na largura de banda.
