...
A mesclagem no \textit{driver} do dispositivo físico é complexa já que afeta todas máquinas virtuais e podemos ter nelas diferentes clientes rodando aplicações com diferentes requisitos. Também depende da placa de rede ter suporte a mesclagem. 
