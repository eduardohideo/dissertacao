...
A atenuação de transmissão e recepção é usada com driver de redes físicos quando a transmissão/recepção de pacotes é muito rapida no meio físico.
Quando pacotes são recebidos e enviados com uma frequência grande, a quantidade de interrupções geradas faz sobrecarregar o processamento. \cite{dong2011optimizing}
